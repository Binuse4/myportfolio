  ...
  return (
    <Card className='group overflow-hidden relative'>
          ...
          <Image 
            ...
            <div className='flex gap-x-4'>
              <Link 
                ...
                justify-center items-center scale-0 group-hover:scale-100 
                group-hover:opacity-100 trasnsition-all duration-200'>
      ...
      <div className='h-full px-8 py-6'>
        ...
        <p className='text-muted-foreground text-md description-container'>{project.description}</p>
      </div>
    </Card>
  )
}
